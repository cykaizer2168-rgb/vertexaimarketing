                ...
                return (
                  <button key={l.id} onClick={() => open(l)}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className={`text-[11.5px] truncate ${isUnread ? 'text-gray-700 font-medium' : 'text-gray-500'}`}>Balcony Solar Inquiry · {l.location || '—'}</p>
            ...
            {!active ? (
              ...
              <>
                ...
                <div className="px-5 py-3.5 border-t border-gray-100 flex flex-wrap gap-2">
                  <a href={`mailto:${active.email}?subject=Re: Balcony Solar Inquiry`} className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#0c1f44] text-white text-[12.5px] font-semibold hover:opacity-90 cursor-pointer">
                  ...
                  <a href="https://m.me/landingsolarcrm_bot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-gray-200 text-gray-700 text-[12.5px] font-medium hover:bg-gray-50 cursor-pointer">

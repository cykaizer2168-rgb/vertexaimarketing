    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-6 lg:px-8 pt-32 pb-24">
        ...
        <div className="mt-14 border-t border-line pt-8 flex flex-wrap items-center gap-3">
          ...
          <a href="mailto:angelo.franco2168@gmail.com?subject=Project%20Inquiry" className="inline-flex items-center gap-2 bg-cyan text-ink font-semibold text-sm px-5 py-3 rounded-lg hover:bg-cyan/90 transition-colors">

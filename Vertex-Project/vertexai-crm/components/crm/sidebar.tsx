...
import { LayoutDashboard, Columns2, Users, Inbox, FormInput, SunMedium, BarChart2, Settings, LogOut, Megaphone, CalendarDays, UserCog, Sparkles, FileText, Newspaper } from 'lucide-react';
...
const nav = [
  ...
  { section: 'Marketing' },
  { label: 'AI Campaign Studio', href: '/crm/campaigns', icon: Sparkles,      badge: 'AI' },
  { section: 'Content' },
  { label: 'Blog',            href: '/crm/blog',         icon: Newspaper,     badge: null },
  { label: 'Case Studies',    href: '/crm/case-studies', icon: FileText,      badge: null },
  { section: 'Tools' },
      ...
      <div className="px-3 py-3 border-t border-black/[0.06]">
        <div className="flex items-center gap-2.5 rounded-xl px-2 py-1.5 hover:bg-black/[0.03] transition-colors">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[10.5px] text-gray-400">{brand.name}</div>
          </div>
          <button

...
export const MOCK_LEADS: Lead[] = [
  ...
  { id:'2', created_at:'2026-06-05T14:00:00Z', name:'Reyes, Manuel', mobile:'+63 918 222 3333', email:'manuel@yahoo.com', location:'Quezon City', monthly_bill:'₱5,000–₱8,000', message:'Renting a condo in QC', stage:'new', system_type:'Plug-in Solar', est_value:60000, lead_source:'messenger', sequence_status:'Queued', notes:'' },

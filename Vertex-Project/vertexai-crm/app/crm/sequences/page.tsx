...
const sequences = [
  {
    ...
    steps:[
      ...
      { num:2, title:'ROI + Growth Results',  tag:'Day 2',     tagColor:'bg-blue-50 text-blue-600',  meta:'68% open rate', wait:'Wait 2 days' },
...
const winback = [
  ...
  { week:'Week 6', title:'Missing-leads reminder',  tag:'Urgency', tagColor:'bg-orange-50 text-orange-600' },

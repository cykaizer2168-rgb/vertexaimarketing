...
import { Users, Mail, Eye, Target, ArrowRight, Bell, RefreshCw } from 'lucide-react';
import Link from 'next/link';
import { STAGE_COLORS, STAGE_DOT } from '@/lib/crm-mock';
import { useLeads, useLeadStats } from '@/lib/use-leads';
import AddLeadModal from '@/components/crm/add-lead-modal';

const PIPELINE_STAGES = ['new','qualified','contacted','proposal','negotiating','closed_won'] as const;
const STAGE_LABEL: Record<string,string> = { new:'New', qualified:'Qualified', contacted:'Contacted', proposal:'Proposal', negotiating:'Negotiation', closed_won:'Closed' };
